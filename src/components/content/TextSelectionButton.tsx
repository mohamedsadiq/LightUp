...
const TextSelectionButton: React.FC<TextSelectionButtonProps> = ({
  ...
  const menuItems: MenuItem[] = useMemo(() => [
    ...
    {
      label: getMessage("actionChallenge", "Challenge"),
      mode: "challenge",
      icon: (
        <svg width="16" height="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path d="M12 3l2.09 6.26H20l-5.17 3.76L16.18 19 12 15.9 7.82 19l1.35-5.98L4 9.26h5.91L12 3z" stroke={iconColor} strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" fill="none" />
        </svg>
      )
    },
    {
