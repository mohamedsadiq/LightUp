...
const ONBOARDING_TOGGLES: {
  ...
  },
  {
    ...
    description:
      "Allow LightUp to use surrounding page info for better answers."
  }
]
...
// Theme tokens for options UI (mapping CSS vars to semantic names)
const theme = {
  ...
  headerBackground: "var(--popup-header)",
  accent: "var(--popup-toggle-active)",
  button: {
  ...
  input: {
    ...
    placeholder: "var(--popup-secondary-text)"
  },
  select: {
  ...
  subcontainer: {
    ...
    border: "var(--popup-subcontainer-border)"
  },
  modelOption: {
    background: "var(--popup-model-option-bg)",
    hover: "var(--popup-model-option-hover)",
    borderHover: "var(--popup-model-option-border-hover)"
  },
  validation: {
    success: "var(--popup-validation-success)",
    error: "var(--popup-validation-error)",
    warning: "var(--popup-validation-warning)"
  },
  badge: {
    background: "var(--popup-badge-bg)",
    border: "var(--popup-badge-border)"
  }
}
